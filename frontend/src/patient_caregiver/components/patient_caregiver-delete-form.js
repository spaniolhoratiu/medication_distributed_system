...
class PatientCaregiverDeleteForm extends React.Component {
    ...
    deletePatientCaregiver(patientCaregiver) {
        return API.deletePatientCaregiver(patientCaregiver, (result, status, error) => {
    ...
    handleSubmit() {
        ...
        this.deletePatientCaregiver(patientCaregiver);
    }
...
export default PatientCaregiverDeleteForm;
