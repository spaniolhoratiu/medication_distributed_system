...
class MedicationPlanDrugDeleteForm extends React.Component {
    ...
    deleteMedicationPlanDrug(medicationPlanDrug) {
        return API.deleteMedicationPlanDrug(medicationPlanDrug, (result, status, error) => {
            if (result !== null && (status === 200 || status === 201)) {
                console.log("Successfully deleted medicationPlanDrug with id: " + result);
                this.reloadHandler();
            } else {
                this.setState(({
                    errorStatus: status,
    ...
    handleSubmit() {
        ...
        this.deleteMedicationPlanDrug(medicationPlanDrug);
    }
        ...
        return (
            <div>
                <FormGroup id='selectedId'>
                    <Label for='selectedIdField'> Selected Medication Plan Drug ID: </Label>
...
export default MedicationPlanDrugDeleteForm;
